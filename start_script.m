...
% -------------------------------
% Simulink-Modellname
modelName = 'Condition_Monitoring_HI'; % Ersetze durch den Namen deines Modells
...
T_heater_loss=0;  % Wear of heater 
...
% % Matrizen definieren
A = [-(a+b)];             % A ist hier einfach ein Skalar
B = [a];       % B ist 1x2
C = [1];           % C ist 1x1, gibt den Zustand direkt als Ausgang
D = [0];         % D ist 1x2, hier ohne direkte Kopplung
